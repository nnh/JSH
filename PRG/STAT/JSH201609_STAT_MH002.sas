...
%MEND;
%BUTT(‘S‘Μ,0,1000,-10000,10000);
%BUTT(‘‘B«ξα‡,1,100,-1000,1000);
%BUTT(‚o‚c‚f‚e‚q‚`A‚o‚c‚f‚e‚q‚aA‚e‚f‚e‚q‚PΩνΗ,2,10,-100,100);
%BUTT(‘Ω`¬E‘‘B«ξα‡,3,50,-500,500);
%BUTT(‘Ω`¬ΗσQ,4,200,-2000,2000);
%BUTT(‹}«‘«”’•a‚¨‚ζ‚ΡΦAξα‡,5,100,-1000,1000);
%BUTT(n“•s–Ύ‹}«”’•a,6,10,-100,100);
%BUTT(‘O‹μƒƒ“ƒp‹…nξα‡,7,50,-500,500);
%BUTT(¬n‚aΧ–Eξα‡iƒƒ“ƒpξE‘ξj,8,600,-6000,6000);
%BUTT(¬n‚sE‚m‚jΧ–Eξα‡,9,100,-1000,1000);
%BUTT(ƒzƒWƒLƒ“ƒƒ“ƒpξ,10,50,-500,500);
%BUTT(‘gD‹…EχσΧ–Eξα‡,11,10,-100,100);
%BUTT(ΪAγƒƒ“ƒp‘B«Ύ³,12,10,-100,100);
