...
%MACRO BUTT(ID,LEN1,LEN2,LEN3,TIT=&TERM.);
  DATA BUTTFY&ID.;
    SET  WK01;
    IF  MHGRPCOD = &ID.;
    ZERO=0;
...
%MEND;
%BUTT(0,1000,-10000,10000);
%BUTT(1,100,-1000,1000);
%BUTT(2,10,-100,100);
%BUTT(3,50,-500,500);
%BUTT(4,200,-2000,2000);
%BUTT(5,100,-1000,1000);
%BUTT(6,10,-100,100);
%BUTT(7,50,-500,500);
%BUTT(8,600,-6000,6000);
%BUTT(9,100,-1000,1000);
%BUTT(10,50,-500,500);
%BUTT(11,10,-100,100);
%BUTT(12,10,-100,100);
