...
# Mamiko Yonejima
# 2019/4/11
# 2020/05/13 Kumiko Agata JSH集計クリーニング
# 2020/05/15 Kumiko Agata NHOH集計クリーニング

day.shimekiri <- "20200430"
kYear <- "2019"
FileNameOutput <- "NHOH_cleaning_DS.csv"
prtpath <- "//192.168.200.222/Datacenter/学会事務/120_血液ネット疾患登録/04.03.02 データ集計/日本血液学会へ提出/2020年/クリーニング/20200515"

rawdatapath <- paste0(prtpath, "/rawdata/")
jsh_report <- read.csv(paste0(rawdatapath, "NHOH_report_200515_1248.csv"), na.strings = c(""), as.is=T, fileEncoding="CP932")
jsh.rgst <- read.csv(paste0(rawdatapath, "NHOH_registration_200515_1248.csv"), na.strings = c(""), as.is=T, fileEncoding="CP932")
