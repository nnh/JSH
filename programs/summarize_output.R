...
output_registration <- paste0("./output/data/JSH_registry_", nowdt, ".csv")
output_disease <- paste0("./output/data/JSH_disease_", nowdt, ".csv")
output_disease_detail <- paste0("./output/data/JSH_disease_detail_", nowdt, ".csv")
